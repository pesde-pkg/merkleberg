...
async fn test_mmriver_leaf_values() {
  ...
  let expected4: [u8; 32] = [
    0x80, 0x05, 0xf0, 0x2d, 0x43, 0xfa, 0x06, 0xe7, 0xd0, 0x58, 0x5f, 0xb6,
    0x4c, 0x96, 0x1d, 0x57, 0xe3, 0x18, 0xb2, 0x7a, 0x14, 0x5c, 0x85, 0x7b,
...
async fn test_mmriver_node_values() {
  ...
  let expected_node2: [u8; 32] = [
    0xad, 0x10, 0x40, 0x51, 0xc5, 0x16, 0x81, 0x2e, 0xa5, 0x87, 0x4c, 0xa3,
    0xff, 0x06, 0xd0, 0x25, 0x83, 0x03, 0x62, 0x3d, 0x04, 0x30, 0x7c, 0x41,
  ...
  let expected_node5: [u8; 32] = [
    0x9a, 0x18, 0xd3, 0xbc, 0x0a, 0x7d, 0x50, 0x5e, 0xf4, 0x5f, 0x98, 0x59,
    0x92, 0x27, 0x09, 0x14, 0xcc, 0x02, 0xb4, 0x4c, 0x91, 0xcc, 0xab, 0xba,
  ...
  let expected_node6: [u8; 32] = [
    0x82, 0x7f, 0x32, 0x13, 0xc1, 0xde, 0x0d, 0x4c, 0x62, 0x77, 0xca, 0xcc,
    0xc1, 0xee, 0xca, 0x32, 0x5e, 0x45, 0xdf, 0xe2, 0xc6, 0x5a, 0xdc, 0xe1,
